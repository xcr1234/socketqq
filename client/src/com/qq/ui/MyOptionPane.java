...
public class MyOptionPane {
    ...
    private static final ImageIcon closeIcon = ImageManager.getIcon("option/close.png");
    private static final ImageIcon closeActiveIcon = ImageManager.getIcon("option/close_active.png");
